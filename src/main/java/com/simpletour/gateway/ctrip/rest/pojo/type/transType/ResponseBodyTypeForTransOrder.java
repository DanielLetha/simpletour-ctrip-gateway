...
public class ResponseBodyTypeForTransOrder {
    /**
     * ota订单号
     */
    ...
    public ResponseBodyTypeForTransOrder() {
    }

    public ResponseBodyTypeForTransOrder(String otaOrderId, String vendorOrderId, String orderStatus, String sourceAmount, Integer count, String useDate, TourismInfo tourismInfo) {
    ...
    public ResponseBodyTypeForTransOrder(List<OrderInfo> orderInfos) {
